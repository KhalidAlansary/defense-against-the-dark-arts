...
<div v-click class="grid grid-cols-2 gap-2 mt-3">
  <img :src="'/images/placeholder-figure.svg'" class="rounded border border-gray-500/20" />
  <img :src="'/images/placeholder-figure.svg'" class="rounded border border-gray-500/20" />
</div>
<div v-click class="text-[10px] opacity-50 mt-1">Replace with: Langfuse trace · pyinstrument report</div>
